    ...
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Lịch sử đơn hàng bạn đã quản lý.</Text>
        </View>
      ...
      <BottomNavigationStaff activeTab="LeaderOrderHistory" onTabPress={(tab) => navigation.navigate(tab)} />
    </SafeAreaView>
  );
}
