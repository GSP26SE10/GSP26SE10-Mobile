...
const mockNotifications = [
  {
    id: 'n1',
    title: 'Đơn mới cần quản lý',
    content: 'Bạn có một buổi tiệc mới trong danh sách quản lý.',
    createdAt: '2026-03-16T09:05:00.000Z',
  },
  {
    id: 'n2',
    title: 'Cập nhật tiến độ',
    content: 'Nhân viên đã hoàn thành một số công việc trong buổi tiệc.',
    createdAt: '2026-03-16T07:15:00.000Z',
  },
  {
    id: 'n3',
    title: 'Nhắc nhở',
    content: 'Vui lòng kiểm tra lại danh sách công việc trước khi bắt đầu tiệc.',
...
export default function LeaderNotificationScreen({ navigation }) {
